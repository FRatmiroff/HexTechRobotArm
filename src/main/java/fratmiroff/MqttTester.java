...
public class MqttTester extends JFrame implements ActionListener {
    ...
    JTextField username = new JTextField("hextech-frank");
    JTextField password = new JTextField("frank");
    JTextField topic = new JTextField("hextech/hextech-frank/commands");
